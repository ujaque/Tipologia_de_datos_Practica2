...
Dado que se cumplen las condiciones de normalidad y homocedasticidad, se aplica la prueba chisquare, para comprobar si existe una relacion significativaentre los grupos de datos (p-valor < 0,05).
...
Dado que el p valor es inferior al valor de alfa, con el nivel de significacion de 0.05 podemos rechazar la hipotesis nula, por lo que podemos considerar que el sexo afecta a la supervivencia, ya que parece que el genero es un buen indicador.
